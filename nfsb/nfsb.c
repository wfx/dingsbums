...
static Fileselect_Widgets g_pub_widgets;
  ...
  const char *icon_favorite = "/icon_emblem_favorite.png";
#endif
...
fileselect_win_main_create(Eo *__main_parent)
{
   ...
   eo_do(vbox, elm_obj_box_padding_set(4, 0));
   ...
   eo_do(hbox, elm_obj_box_padding_set(4, 0));
   ...
   eo_do(elm_box3, evas_obj_size_set(0, 0));
   eo_do(elm_box3, evas_obj_size_hint_min_set(0, 28));
   elm_label1 = eo_add(ELM_LABEL_CLASS, elm_box3);
   eo_do(elm_label1, evas_obj_size_hint_weight_set(1.000000, 1.000000));
   eo_do(elm_label1, evas_obj_visibility_set(EINA_TRUE));
   eo_do(elm_label1, evas_obj_size_hint_align_set(-1.000000, -1.000000));
   eo_do(elm_label1, evas_obj_size_set(0, 0));
   eo_do(elm_label1, elm_obj_widget_part_text_set(NULL, "Places"));
   eo_do(elm_label1, elm_obj_widget_disabled_set(EINA_FALSE));
   eo_do(elm_label1, evas_obj_size_hint_min_set(0, 28));
   ...
   elm_box6 = eo_add(ELM_BOX_CLASS, box_bookmarks);
   eo_do(elm_box6, evas_obj_visibility_set(EINA_TRUE));
   eo_do(elm_box6, evas_obj_size_hint_align_set(-1.000000, -1.000000));
   eo_do(elm_box6, evas_obj_size_hint_weight_set(1.000000, 0.000000));
   ...
   eo_do(box_bookmarks, elm_obj_box_pack_end(elm_box6));
   add_bookmark_btn = eo_add(ELM_BUTTON_CLASS, elm_box6);
   ...
   eo_do(add_bookmark_btn, elm_obj_widget_part_text_set(NULL, "+"));
   eo_do(add_bookmark_btn, evas_obj_size_hint_align_set(-1.000000, 0.500000));
   eo_do(add_bookmark_btn, elm_obj_widget_disabled_set(EINA_TRUE));
   elm_button1 = eo_add(ELM_BUTTON_CLASS, elm_box6);
   eo_do(elm_button1, evas_obj_size_hint_weight_set(1.000000, 1.000000));
   eo_do(elm_button1, evas_obj_visibility_set(EINA_TRUE));
   eo_do(elm_button1, evas_obj_size_set(73, 30));
   eo_do(elm_button1, elm_obj_widget_part_text_set(NULL, "-"));
   eo_do(elm_button1, evas_obj_size_hint_align_set(-1.000000, 0.500000));
   eo_do(elm_button1, elm_obj_widget_disabled_set(EINA_TRUE));
   eo_do(elm_box6, elm_obj_box_pack_end(add_bookmark_btn));
   eo_do(elm_box6, elm_obj_box_pack_end(elm_button1));
   ...
   eo_do(elm_box1, elm_obj_box_padding_set(2, 0));
   eo_do(elm_box1, evas_obj_size_hint_min_set(0, 28));
   ...
   eo_do(elm_box4, evas_obj_size_hint_min_set(102, 28));
   eo_do(elm_box4, elm_obj_box_padding_set(0, 0));
   ...
   eo_do(select_btn, elm_obj_widget_disabled_set(EINA_TRUE));
   eo_do(select_btn, evas_obj_size_hint_align_set(-1.000000, 0.500000));
   ...
   eo_do(elm_button2, evas_obj_size_hint_align_set(-1.000000, 0.500000));
